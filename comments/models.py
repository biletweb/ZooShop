...
class Comments(models.Model):
    ...
    answer = models.ForeignKey('Comments', blank=True, on_delete=models.CASCADE, null=True, related_name='replies', verbose_name='Ответ')
    validation = models.BooleanField(default=True, verbose_name='Прошёл проверку')
